  ...
  const cards = [
    {
      ...
      subtitle: "All rows in selected scope",
    ...
    },
    {
      ...
      value: metrics.totalUniqueOrders,
      subtitle: "Distinct order IDs",
    ...
    },
    {
      ...
      subtitle: "Profit divided by sales",
    ...
    },
    {
      ...
      value: metrics.totalShippingCost,
      subtitle: "Freight spend",
    ...
    },
    {
      ...
      subtitle: "Sales per unique order",
      gradient: "from-blue-600 to-cyan-600",
      icon: DollarSign,
    },
    {
      title: "Avg. Quantity Ordered",
      value: metrics.avgQuantityOrdered,
      subtitle: "Quantity per unique order",
      gradient: "from-teal-500 to-emerald-600",
      icon: Target,
    },
    {
      title: "Max. Sale",
      value: metrics.maxSale,
      subtitle: "Largest single sale",
      gradient: "from-emerald-500 to-lime-600",
      icon: DollarSign,
    },
    {
      title: "Min. Sale",
      value: metrics.minSale,
      subtitle: "Smallest single sale",
